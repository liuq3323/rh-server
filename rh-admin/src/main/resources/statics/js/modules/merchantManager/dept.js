...
var vm = new Vue({
    ...
    methods: {
        ...
        update: function () {
            ...
            $.get(baseURL + "merchant/dept/info/" + deptId, function (r) {
                vm.showList = false;
                vm.title = "修改";
                vm.dept = r.dept;
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "merchant/dept/delete",
                    data: "deptId=" + deptId,
                    success: function (r) {
                        if (r.code === 0) {
                            alert('操作成功', function () {
        ...
        saveOrUpdate: function (event) {
            var url = vm.dept.deptId == null ? "merchant/dept/save" : "merchant/dept/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
...
$(function () {
    $.get(baseURL + "merchant/dept/info", function (r) {
        var colunms = Dept.initColumn();
        var table = new TreeTable(Dept.id, baseURL + "merchant/dept/list", colunms);
