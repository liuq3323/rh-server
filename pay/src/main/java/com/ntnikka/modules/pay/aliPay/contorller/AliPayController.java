...
import com.ntnikka.modules.common.utils.AliPayRequest;
import com.ntnikka.modules.common.utils.HttpClientUtil;
import com.ntnikka.modules.common.utils.IdWorker;
...
//        }
    ...
    @RequestMapping(value = "testOrderList" , method = RequestMethod.POST)
    public R testOrderList(){
        Long merchantId = 10001L;
        Map<String , Object> map = new HashMap<>();
